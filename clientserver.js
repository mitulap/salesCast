...
app.use(express.static(__dirname + "/public/serverclientdetails"));
//app.use(express.static(path.join(__dirname + "public/serverclientdetails.html")));
...
/*app.get('/', function (req, res) {
    res.sendFile(path.join(__dirname + '/public/serverclientdetails/'));
});*/
